...
ggplot(data = diamonds.sample) +
  geom_point(color = 'blue', mapping = aes(x = carat, y = price))
...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(x = carat, y = price, size = cut, color = price))
...
ggplot(data = diamonds.sample) +
  geom_histogram(mapping = aes(x = price, color = clarity) )
